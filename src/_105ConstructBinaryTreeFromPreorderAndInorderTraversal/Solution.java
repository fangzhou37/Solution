package _105ConstructBinaryTreeFromPreorderAndInorderTraversal;
...
public class Solution {
    ...
    private TreeNode buildTreeHelper(int[] preorder, int[] inorder, int preStart, int preEnd, int inStart) {
        if (preStart > preEnd) {
            return null;
        }
